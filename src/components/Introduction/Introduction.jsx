    ...
    <div className="intro">
      <div className="intro-left">
        <div className="intro-left-wrapper">
          ...
          <p>*Call me Ha Ha sounds like you are laughing*</p>
          ...
          <div className="intro-description">
            I am a new grad from Software Engineering program at Centennial college. So excited to join tech industry as role of Frontend/Backend Developer. 
          </div>
        </div>
      </div>
